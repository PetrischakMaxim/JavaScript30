    ...
    const fiveteens = inventors.filter(inventor => inventor.year >= 1500 && inventor.year > 1600);
    //console.table(fiveteens);
    ...
    const data = ['aff','car', 'car', 'truck', 'truck', 'bike', 'walk', 'car', 'van', 'bike', 'walk', 'car', 'van', 'car',
        'truck'
    ];
